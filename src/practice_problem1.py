...
class Box(object):
    ...
    def append_string(self, additional_contents):
        ...
        if len(self.contents + additional_contents) <= self.volume:
            ...
            self.contents = (self.contents + additional_contents)[:self.volume]
            return full[self.volume:]
    ...
    def double_then_shrink(self, new_volume):
        ...
        # --------------------------------------------------------------
        disc = 0
        disc += len(self.double())
        disc += len(self.shrink(new_volume))
        return disc
    ...
    def reset(self):
        ...
        self.contents = self.old_contents
